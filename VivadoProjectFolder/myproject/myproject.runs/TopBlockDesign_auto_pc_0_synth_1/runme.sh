...
HD_PWD='D:/DIY/Radio_SW/VivadoProjectFolder/myproject/myproject.runs/TopBlockDesign_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TopBlockDesign_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TopBlockDesign_auto_pc_0.tcl
