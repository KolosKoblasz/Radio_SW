...
HD_PWD='D:/DIY/Radio_SW/VivadoProjectFolder/myproject/myproject.runs/TopBlockDesign_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TopBlockDesign_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TopBlockDesign_xbar_0.tcl
