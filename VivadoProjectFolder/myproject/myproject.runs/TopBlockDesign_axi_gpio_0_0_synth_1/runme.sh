...
HD_PWD='D:/DIY/Radio_SW/VivadoProjectFolder/myproject/myproject.runs/TopBlockDesign_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TopBlockDesign_axi_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TopBlockDesign_axi_gpio_0_0.tcl
