...
HD_PWD='D:/DIY/Radio_SW/VivadoProjectFolder/myproject/myproject.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TopBlockDesign_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TopBlockDesign_wrapper.tcl -notrace
