...
HD_PWD='D:/DIY/Radio_SW/VivadoProjectFolder/myproject/myproject.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TopBlockDesign_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TopBlockDesign_wrapper.tcl
