...
#
# Build.tcl: Tcl script for re-creating project 'RadioFirmware'
#
# Generated by Vivado on Sat Mar 30 20:58:49 +0100 2019
...
#
#    "D:/DIY/Radio_SW/BlockDesign/TopLevelBlocks/hdl/TopLevelBlocks_wrapper.v"
...
#    "D:/DIY/Radio_SW/Constrains/Constrains_1.xdc"
#
#*****************************************************************************************
...
set _xil_proj_name_ "RadioFirmware"
...
set files [list \
 [file normalize "${origin_dir}/../BlockDesign/TopLevelBlocks/hdl/TopLevelBlocks_wrapper.v"] \
...
set file "$origin_dir/../BlockDesign/TopLevelBlocks/hdl/TopLevelBlocks_wrapper.v"
...
set file "$origin_dir/../VerilogModules/DDS.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/../VerilogModules/DualPortBRAM.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/../TestBenches/tb_DDS.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/../TestBenches/tb_DDS_Amplitude_Control.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/../TestBenches/tb_DDS_Modulations.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set_property -name "top" -value "TopLevelBlocks_wrapper" -objects $obj
...
set file "[file normalize "$origin_dir/../Constrains/Constrains_1.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/../Constrains/Constrains_1.xdc"
set file [file normalize $file]
...
set_property -name "top" -value "tb_DDS" -objects $obj
...
# Proc to create BD TopLevelBlocks
proc cr_bd_TopLevelBlocks { parentCell } {
...
preplace port gpio_rtl -pg 1 -y 380 -defaultsOSRD
preplace port UART_0 -pg 1 -y -130 -defaultsOSRD
preplace port FIXED_IO -pg 1 -y -150 -defaultsOSRD
preplace inst axi_gpio_0 -pg 1 -lvl 3 -y 380 -defaultsOSRD
preplace inst axi_interconnect_0 -pg 1 -lvl 2 -y 140 -defaultsOSRD
preplace inst rst_ps7_0_100M -pg 1 -lvl 2 -y -280 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 1 -y -130 -defaultsOSRD
preplace netloc processing_system7_0_DDR 1 1 3 NJ -180 N -180 1030
preplace netloc processing_system7_0_UART_0 1 1 3 440 -130 N -130 N
preplace netloc rst_ps7_0_100M_peripheral_aresetn 1 1 2 440 260 800
preplace netloc processing_system7_0_FCLK_RESET0_N 1 1 1 430
preplace netloc S00_AXI_1 1 1 1 410
preplace netloc processing_system7_0_FIXED_IO 1 1 3 NJ -160 N -160 1030
preplace netloc axi_gpio_0_GPIO 1 3 1 N
preplace netloc axi_interconnect_0_M00_AXI 1 2 1 790
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 10 -20 420 380 N
levelinfo -pg 1 -10 210 620 920 1050 -top -400 -bot 480
"
}
...
# End of cr_bd_TopLevelBlocks()
cr_bd_TopLevelBlocks ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files TopLevelBlocks.bd ] 
set_property GENERATE_SYNTH_CHECKPOINT "1" [get_files TopLevelBlocks.bd ] 
set_property IS_ENABLED "1" [get_files TopLevelBlocks.bd ] 
set_property IS_GLOBAL_INCLUDE "0" [get_files TopLevelBlocks.bd ] 
set_property IS_LOCKED "0" [get_files TopLevelBlocks.bd ] 
set_property LIBRARY "xil_defaultlib" [get_files TopLevelBlocks.bd ] 
set_property PATH_MODE "RelativeFirst" [get_files TopLevelBlocks.bd ] 
set_property PFM_NAME "" [get_files TopLevelBlocks.bd ] 
set_property REGISTERED_WITH_MANAGER "1" [get_files TopLevelBlocks.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files TopLevelBlocks.bd ] 
set_property USED_IN "synthesis implementation simulation" [get_files TopLevelBlocks.bd ] 
set_property USED_IN_IMPLEMENTATION "1" [get_files TopLevelBlocks.bd ] 
set_property USED_IN_SIMULATION "1" [get_files TopLevelBlocks.bd ] 
set_property USED_IN_SYNTHESIS "1" [get_files TopLevelBlocks.bd ] 
...
# Create block design
 source $origin_dir/BlockDesign/TopLevelBlocks.tcl
